        ...
        <div class="sidebar_inner" data-simplebar>
            <div class="flex flex-col items-center my-6 uk-visible@s">
                <div
                    ...
                    <img
                        src="https://scontent.fhan2-4.fna.fbcdn.net/v/t39.30808-6/283884527_754952275541196_638942214170894174_n.jpg?_nc_cat=100&ccb=1-7&_nc_sid=174925&_nc_ohc=NaxAc0VqOycAX8IleAY&_nc_ht=scontent.fhan2-4.fna&oh=00_AT86mDcDhjNJ4Rp2F1I05NNh6qjll10NhR46VAe64gXo7A&oe=62D6EB8A"
                        class="bg-gray-200 border-4 border-white rounded-full w-full h-full">
                </div>
                <a href="#" class="text-xl font-medium capitalize mt-4 uk-link-reset"> Linh khoai lớn
                </a>
                ...
                <div class="right-side lg:pr-4">
                    ...
                    <div uk-drop="mode: click;offset: 4" class="header_dropdown">
                        ...
                        <ul class="dropdown_scrollbar" data-simplebar>
                            <li>
                                <a href="#">
                                    <div class="drop_avatar"><img src="{{asset("assets/images/avatars/avatar-1.jpg")}}"
                                                                  alt="">
                                    </div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="drop_avatar"><img src="{{asset("assets/images/avatars/avatar-2.jpg")}}"
                                                                  alt="">
                                    </div>
                                    <div class="drop_content">
                                        <p>
                            ...
                            <li>
                                <a href="#">
                                    <div class="drop_avatar"><img src="{{asset("assets/images/avatars/avatar-3.jpg")}}"
                                                                  alt="">
                                    </div>
                                    <div class="drop_content">
                                        <p>
